...
export function FormsSection() {
  ...
  return (
    <Section id="forms" title="表单" blurb="输入、选择与开关控件，校验文案经 aria-describedby 关联。">
      <DemoCard name="Field" description="带标签的输入框：icon、hint 与 errorText 状态。">
      ...
      <DemoCard name="FieldShell" description="带图标/尾随区的输入外壳，内部控件自由组合。">
