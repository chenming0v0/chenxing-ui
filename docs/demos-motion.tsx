...
export const MOTION_ENTRIES: DemoEntry[] = [
  {
    slug: 'reveal',
    name: 'Reveal',
    description: '进入视口后渐现：rise 整体上移淡入，mask 行揭示。',
    Demo: () => (
  ...
  },
  {
    slug: 'count-up',
    name: 'CountUp',
    description: '进入视口后数字滚动到目标值，reduced-motion 时直落终值。',
    Demo: CountUpDemo,
  },
  {
    slug: 'typewriter',
    name: 'Typewriter',
    description: '多词循环打字机，附终端光标。',
    Demo: () => (
      <p className="chenxing-h2">
  ...
  },
  {
    slug: 'scramble-text',
    name: 'ScrambleText',
    description: '打字机式乱码解码：先打出乱码，再逐位替换为真字。',
    Demo: ScrambleDemo,
  },
  {
    slug: 'draw-line',
    name: 'DrawLine',
    description: '进入视口后从左到右绘制的分割线。',
    Demo: () => (
  ...
  },
  {
    slug: 'warp-field',
    name: 'WarpField',
    description: '曲速星场画布，常用于关键操作页的背景层。',
    Demo: () => (
  ...
  },
  {
    slug: 'space-backdrop',
    name: 'SpaceBackdrop',
    description: '星幕 + 星云 + 网格 + 晕影的页面背景根容器——本站背景就是它的实时演示。',
    wide: true,
    Demo: () => (
  ...
  },
  {
    slug: 'intro-gate',
    name: 'IntroGate',
    description: '开场闸门：整屏盖板计数到 100 后上滑揭示页面，完成后从 DOM 卸载。',
    Demo: IntroGateDemo,
  },
  {
    slug: 'skip-link',
    name: 'SkipLink / SkipTarget',
    description: '键盘可达的「跳到主内容」。本站已内置：把焦点移到页面最前（点击地址栏后按 Tab）即可看到它从顶部滑入。',
    imports: ['SkipLink', 'SkipTarget', 'useSkipTargetId'],
    Demo: () => (
      <p className="chenxing-caption max-w-md text-center">
